...
export const communityPosts = [
  {
    ...
    author: { name: "Ben Carter", avatarUrl: placeholderImages[2].imageUrl },
  ...
  },
  {
    ...
    author: { name: "Mei Lin", avatarUrl: placeholderImages[3].imageUrl },
    timestamp: "1 day ago",
    votes: 15,
    comments: 8,
  },
  {
    ...
    author: { name: "Priya Sharma", avatarUrl: placeholderImages[1].imageUrl },
